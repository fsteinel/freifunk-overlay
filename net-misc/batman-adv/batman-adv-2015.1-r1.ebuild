...
src_prepare(){
	patch -p1 -l <"${FILESDIR}/0001-batman-adv-Init-and-use-batman-interface-with-correc.patch"
	patch -p1 -l < "${FILESDIR}/0002-batman-adv-Restrict-movement-of-batman-interfaces-be.patch"
	#epatch "${FILESDIR}/0001-batman-adv-Init-and-use-batman-interface-with-correc.patch"
	#epatch "${FILESDIR}/0002-batman-adv-Restrict-movement-of-batman-interfaces-be.patch"
}
